package ro.ase.csie.cts.g1087.dp.singleton.registru;
...
public class ConexiuneBD {
	...
	private static Hashtable<String, ConexiuneBD> conexiuni = new Hashtable<>(); //varianta Hashtable pentru Singleton
